    ...
    public async Task<SubPostFeedResponse> GetFeedSubPostAsync(IdBaseR request)
    {
        ...
        var query = $@"WITH SubPostsCount AS (
                        ...
                        ResourceCount AS (
                            ...
                            LEFT JOIN ""document"".""DocumentResources"" r ON sp.""Id"" = r.""SubPostId""
                        ...
                        SELECT 
                            ...
                            COALESCE(psb.""HashId"", (
                                SELECT ps.""HashId"" 
                                FROM ""document"".""DocumentSubPosts"" ps 
                        ...
                        LEFT JOIN ""document"".""DocumentSubPosts"" psb ON sp.""PostId"" = psb.""PostId""
                         AND sp.""Order"" = psb.""Order"" + 1
                         AND psb.""IsDelete"" = false
                         LEFT JOIN ""document"".""DocumentSubPosts"" asp ON sp.""PostId"" = asp.""PostId""
        ...
        {
            var postData = await _postRepository.Connection.QueryFirstAsync<SubPostFeedResponse>($@"SELECT ""Body"",""Id"",""HashId"" from ""document"".""DocumentPosts""  WHERE ""HashId"" =@Id", new { Id = data.HashId });
            data.Id = postData.Id;
