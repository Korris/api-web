...
public partial class TagService : ITagService
{
    ...
    public async Task<List<string>> UpdateTagsToPost(Guid postId, List<string>? tags, Guid userId)
    {
        ...
        if (tags == null)
        {
            await _context.DocumentTagPosts
    ...
    {
        var tagPostsToInsert = new List<DocumentTagPost>();

        foreach (var i in tagIds)
        {
            tagPostsToInsert.Add(new DocumentTagPost
            {
                IsDelete = false,
                PostId = postId,
                TagId = i,
        ...
        await _context.DocumentTagPosts.AddRangeAsync(tagPostsToInsert);
    ...
    public async Task<PagedResponse<TagSearchResponse>> SearchTagbyKeyword(TagSearchR input)
    {
        ...
        var query = $@"
                                ...
                                LEFT JOIN document.""DocumentTagPosts"" tp  
                                ON tp.""TagId""  = t.""Id"" 
                                LEFT JOIN ""document"".""DocumentPosts""  p 
                                ON p.""Id""  = tp.""PostId"" 
                                ...
                                FROM (
                                    ...
                                    FROM ""document"".""DocumentPosts""  post
                                    INNER JOIN document.""DocumentTagPosts"" tagpost ON post.""Id"" = tagpost.""PostId"" 
