...
public partial class FeedService : IFeedService
{
    ...
    public async Task<PagedResponse<FeedDto>> GetFeedsAsync(FeedLoadReq feedLoadReq, LoadFeedType loadFeedType)
    {
        try
        {
            ...
            {
                feedLoadReq.OrderBy = nameof(ComicPost.CreatedOn);
            }
            var query = "";
    ...
    public async Task<SubPostFeedResponse> GetFeedSubPostAsync(IdBaseR request)
    {
        ...
        var query = $@"WITH SubPostsCount AS (
                        ...
                        ResourceCount AS (
                            ...
                            LEFT JOIN ""comic"".""ComicResources"" r ON sp.""Id"" = r.""SubPostId""
                        ...
                        LEFT JOIN ""comic"".""ComicSubPosts"" psb ON sp.""PostId"" = psb.""PostId""
                         AND sp.""Order"" = psb.""Order"" + 1
                         AND psb.""IsDelete"" = false
                         LEFT JOIN ""comic"".""ComicSubPosts"" asp ON sp.""PostId"" = asp.""PostId""
        ...
        {
            var postData = await _postRepository.Connection.QueryFirstAsync<SubPostFeedResponse>($@"SELECT ""Body"",""Id"",""HashId"" from ""comic"".""ComicPosts""  WHERE ""HashId"" =@Id", new { Id = data.HashId });
            data.Id = postData.Id;
