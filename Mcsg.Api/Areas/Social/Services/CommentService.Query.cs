                                                         ...
                                                         AND (
                                                           pc.""ParentId"" IS NULL
                                                             OR (
                                                               ...
                                                               AND EXISTS (
                                                                 SELECT *
                                                                 FROM ""social"".""SocialPostComments"" pc1
                                                         ...
                                                         AND (
                                                           spc.""ParentId"" IS NULL
                                                             OR (
                                                               ...
                                                               AND EXISTS (
                                                                 SELECT *
                                                                 FROM ""social"".""SocialSubPostComments"" spc1
        ...
        private string GetCommentOfPostQuery
        {
            get
            {
                return @$"      WITH RECURSIVE cte AS (
                                ...
                                LEFT JOIN ""social"".""SocialResources"" res ON cte.""ResourceId"" = res.""Id""
        ...
        private string GetCommentByPostInHomePageQuery
        {
            get
            {
                return @$"SELECT com.""Id"", com.""PostId""
                                ...
                                LEFT JOIN ""social"".""SocialResources"" res ON com.""ResourceId"" = res.""Id""
                                ...
                                LEFT JOIN ""social"".""SocialResources"" repRes ON rep.""ResourceId"" = repRes.""Id""
        ...
        private string CountSubPostOfPostQuery
        {
            get
            {
                return $@"SELECT T1.""PostId"", COUNT (DISTINCT T1.""Id"") AS ""Count"" 
                        FROM ""social"".""SocialSubPosts"" T1
                        LEFT JOIN ""social"".""SocialSubPosts"" T2
