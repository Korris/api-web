...
/// <summary>
/// Reactions on game posts and comments (api/game/reaction). Same route shape as the Comic ReactionController.
/// </summary>
[ApiController]
...
public class ReactionController : ControllerBase
{
    ...
    public ReactionController(IGameReactService reactService)
    {
