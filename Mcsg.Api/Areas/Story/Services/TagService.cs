...
public partial class TagService : ITagService
{
    ...
    {
        _context = context;
        _tagPostRepository = unitOfWork.GetRepository<StoryTagPost>();
    ...
    public async Task<List<string>> AddTagsToPost(Guid postId, List<string> tags, Guid userId)
    {
        ...
        var qTagPost = _context.Available<StoryTagPost>().Where(p => p.PostId == postId);
    ...
    public async Task<PagedResponse<TagSearchResponse>> SearchTagbyKeyword(TagSearchR input)
    {
        ...
        var query = $@"
                                ...
                                FROM (
                                    ...
                                    INNER JOIN story.""StoryTagPosts"" tagpost ON post.""Id"" = tagpost.""PostId"" 
