...
/// </summary>
public class HostedDownloadImage : BackgroundService
{
    #region -- Overrides --
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        using (var scope = _ss.CreateScope())
        {
            ...
            var service = scope.ServiceProvider.GetRequiredService<IDownloadImage>();
    ...
    public HostedDownloadImage(IServiceScopeFactory ss)
    {
        $"Initialize {nameof(HostedDownloadImage)}".LogInfor();
