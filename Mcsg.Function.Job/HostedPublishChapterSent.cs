...
/// </summary>
public class HostedPublishChapterSent : BackgroundService
{
    #region -- Overrides --
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        using (var scope = _ss.CreateScope())
        {
            ...
            var service = scope.ServiceProvider.GetRequiredService<IPublishChapterSentService>();
    ...
    public HostedPublishChapterSent(IServiceScopeFactory ss)
    {
        $"Initialize {nameof(HostedPublishChapterSent)}".LogInfor();
