        ...
        private string GetFeedQuery
        {
            get
            {
                return @"SELECT 
						...
						p.""UserId"",u.""Avatar"",u.""ProfileName"", u.""ProfileId"", p.""CreatedDate"",
						p.""Status"", p.""Type"", p.""CreatedDate"", p.""CustomNote"",
						sp.""Id"",sp.""HashId"",sp.""Title"", sp.""Status"",sp.""CreatedDate"",
						sp.""Permission"",sp.""PublishDate"",sp.""Order"",
						spr.""Id"",
            ...
            get
            {
                return @"
					SELECT 
						...
						to_jsonb(ARRAY_AGG(sp.*)) AS ""story"".""StorySubPosts"",
						to_jsonb(ARRAY_AGG(spr.*)) AS ""story"".""StoryResources"",
						jsonb_build_object(
