...
public partial class SmartLookupService : ISmartLookupService
{
    ...
    public SmartLookupService(McsgContext context, ISetting setting, DistributeManager distributeManager, IRepository<Tag> tagRepository, IRepository<SmartLookupUser> smartLookupUserRepository, IRepository<SmartLookup> smartLookupRepository, IRepository<StoryTagPost> tagPostRepository, IRepository<User> userRepository)
    {
        _context = context;
        _setting = setting;
