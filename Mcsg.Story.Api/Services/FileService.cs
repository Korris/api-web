...
public class FileService : IFileService
{
    ...
    private async Task<Tuple<List<StoryResource>, List<SubUploadFileDto>>> CompleteFilesSubPostAsync(List<ResourcePostDto> req, Guid userId, string userName, string userFolder, string userAvatar, Guid postId, bool addSubPost)
    {
    ...
    /// <returns></returns>
    /// <exception cref="NotFoundException"></exception>
    private async Task<IEnumerable<StoryResource>> CompleteFilesAsync(List<ResourcePostDto> req, Guid userId, string userName, string userFolder, string userAvatar, Guid postId, bool addSubPost)
    {
        var response = new List<StoryResource>();
        if (string.IsNullOrWhiteSpace(userFolder))
        {
