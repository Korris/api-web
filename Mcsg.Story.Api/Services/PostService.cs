...
public partial class PostService : IPostService
{
    ...
    public async Task<PostSeriesResponse> PostCreate(StoryPostCreateR request)
    {
        ...
        await _googleSheet.WriteDataToSheet(PostType.Story, _setting.Environment, link, email, post.HashId, request.UserName, post.CreatedOn, post.Body, request.RemoteIp, "Web");
