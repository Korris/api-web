...
public interface IPostService
{
    ...
    Task<SocialSubPost> SubPostChapterToSeries(string hashId, StoryChapterPostR chapterPostReq);
    Task<SocialSubPost> SubPostUpdateChapterToSeries(string hashId, int order, StoryChapterPostR chapterPostReq);
    ...
    ChapterResponse MappingChapterResponse(SocialSubPost newChapter);
