...
public class JobService : IJobService
{
    ...
    private async Task ConvertVideo(SocialResource resource, string userName, string userAvatar, string blobName)
    {
    ...
    private async Task ConvertAudio(SocialResource resource, string userName, string userAvatar, string blobName)
    {
        bool canConvert = true;
        string fileExtension = Path.GetExtension(blobName);
        if (!Setting.FileExt.AllowPlayAfterUpload.Contains(fileExtension, StringComparer.OrdinalIgnoreCase))
