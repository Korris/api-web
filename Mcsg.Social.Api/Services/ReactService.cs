...
public partial class ReactService<T> : IReactService<T> where T : BaseReaction, new()
{
    ...
    private async Task SendReactNotificationAsync(Guid reactionId, Guid targetId, ReactionType reactionType)
    {
        ...
        notiReq.EntityType = entityType.Name switch
        {
            ...
            nameof(SocialPostCommentReaction) => NotificationEntityType.PostCommentReaction,
            nameof(SocialSubPostCommentReaction) => NotificationEntityType.SubPostCommentReaction,
