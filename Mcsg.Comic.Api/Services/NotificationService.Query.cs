        ...
        private string GetNotificationByUserQuery
        {
            get
            {
                return @$"SELECT noti.""Id"", noti.""ReceiverId""
                            ...
                            LEFT JOIN comic.""ComicPostReactions"" pr ON obj.""EntityId"" = pr.""Id"" AND obj.""EntityType"" = {(int)NotificationEntityType.SocialPostReaction}
                            LEFT JOIN comic.""ComicSubPostReactions"" spr ON obj.""EntityId"" = spr.""Id"" AND obj.""EntityType"" = {(int)NotificationEntityType.SocialSubPostReaction}
                            LEFT JOIN comic.""ComicPostComments"" pcr ON obj.""EntityId"" = pcr.""Id"" AND obj.""EntityType"" = {(int)NotificationEntityType.SocialPostCommentReaction}
                            LEFT JOIN comic.""ComicSubPostComments"" spcr ON obj.""EntityId"" = spcr.""Id"" AND obj.""EntityType"" = {(int)NotificationEntityType.SocialSubPostCommentReaction}
