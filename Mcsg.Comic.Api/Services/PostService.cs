...
public partial class PostService : BaseMinioS, IPostService
{
    ...
    public PostService(IMcsgContext context, ISetting setting, IStorageClient sc, GoogleSheet googleSheet, IUnitOfWork unitOfWork, ITagService tagService, IFileService fileService, IMapper mapper, ISmartLookupService smartLookupService, IRepository<ComicPostComment> postCommentRepository) : base(context, setting, sc)
    {
    ...
    public async Task HandleThumbnailUrlAndCoverUrl(ComicPost post, bool isDelete, Guid userId)
    {
