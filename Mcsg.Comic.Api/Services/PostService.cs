...
public partial class PostService : IPostService
{
    ...
    public PostService(IMcsgContext context, ISetting setting, IStorageClient sc, GoogleSheet googleSheet, IUnitOfWork unitOfWork, ITagService tagService, IRepository<SmartLookup> smartLookupRepository, IFileService fileService, IMapper mapper, ISmartLookupService smartLookupService, IValidator<ComicPostReport> postReportValidator, IRepository<ComicPostComment> postCommentRepository)
    {
        _context = context;
        _setting = setting;
        _sc = sc;
