...
partial class DocumentPost
{
    ...
    public static DocumentPost Create(string? title, string? body, string? thumbnailUrl, string? authorName, string? customNote, Guid createdBy)
    {
    ...
    public SearchDto ToSearchDto()
    {
        ...
        res.NumberOfComments = DocumentPostComments.Count;
