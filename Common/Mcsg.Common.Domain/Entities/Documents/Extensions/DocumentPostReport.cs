...
partial class DocumentPostReport
{
    #region -- Methods --
    ...
    public static DocumentPostReport Create(Guid postId, Guid userId, ReasonType reasonType, string? reasonText)
    {
        var res = new DocumentPostReport
        {
            PostId = postId,
            UserId = userId,
