...
partial class ComicPostReport
{
    ...
    public static ComicPostReport Create(Guid postId, Guid userId, ReasonType reasonType, string? reasonText)
    {
        var res = new ComicPostReport
        {
            PostId = postId,
            UserId = userId,
