...
partial class ComicReport
{
    ...
    public static ComicReport Create(Guid entityId, EntityType entityType, ReportStatus status, DateTime? ExpiredBlock)
    {
        var res = new ComicReport
        {
            EntityId = entityId,
