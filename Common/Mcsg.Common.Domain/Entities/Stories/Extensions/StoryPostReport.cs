...
partial class StoryPostReport
{
    ...
    public static StoryPostReport Create(Guid postId, Guid userId, ReasonType reasonType, string? reasonText)
    {
        var res = new StoryPostReport
        {
            PostId = postId,
            UserId = userId,
