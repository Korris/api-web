namespace Mcsg.Document.Api.Services
{
    ...
    public partial class CommentService
    {
        ...
        private string GetReplyByCommentIdQuery = @"SELECT 
                                               ...
                                               FROM {0} pc
                                               LEFT JOIN ""document"".""DocumentResources"" r on pc.""ResourceId"" = r.""Id""
        ...
        private string GetCommentWithMostReactionQuery = $@"
                                                SELECT 
                                                    ...
                                                    u.""ProfileId"",
                                                   (SELECT COUNT(*) 
                                                   FROM ""document"".""DocumentPostComments"" reply 
                                                ...
                                                LEFT JOIN ""document"".""DocumentPostComments"" reply on reply.""ParentId"" = pc.""Id"" AND reply.""IsDelete"" = false
                                                ...
                                                SELECT 
                                                    ...
                                                    u.""ProfileId"",
                                                    (SELECT COUNT(*) 
                                                    FROM ""document"".""DocumentSubPostComments"" reply 
                                                    LEFT JOIN identity.""Users"" ur on reply.""CreatedBy"" = ur.""Id""
                                                ...
                                                LEFT JOIN ""document"".""DocumentSubPostComments"" reply on reply.""ParentId"" = spc.""Id"" AND reply.""IsDelete"" = false
                                                ...
                                                LEFT JOIN ""document"".""DocumentResources"" r on spc.""ResourceId"" = r.""Id""
                                                WHERE sp.""PostId"" = (SELECT ""Id"" FROM ""document"".""DocumentPosts""   WHERE ""HashId"" =@HashId) 
                                                         ...
                                                         AND (
                                                           pc.""ParentId"" IS NULL
                                                             OR (
                                                               ...
                                                               AND EXISTS (
                                                                 SELECT *
                                                                 FROM ""document"".""DocumentPostComments"" pc1
                                                         ...
                                                         AND (
                                                           spc.""ParentId"" IS NULL
                                                             OR (
                                                               ...
                                                               AND EXISTS (
                                                                 SELECT *
                                                                 FROM ""document"".""DocumentSubPostComments"" spc1
        ...
        private string GetCommentOfPostQuery
        {
            get
            {
                return @$"      WITH RECURSIVE cte AS (
                                ...
                                LEFT JOIN ""document"".""DocumentResources"" res ON cte.""ResourceId"" = res.""Id""
        ...
        private string GetCommentByPostInHomePageQuery
        {
            get
            {
                return @$"SELECT com.""Id"", com.""PostId""
                                ...
                                LEFT JOIN ""document"".""DocumentResources"" res ON com.""ResourceId"" = res.""Id""
        ...
        private string CountSubPostOfPostQuery
        {
            get
            {
                return $@"SELECT T1.""PostId"", COUNT (DISTINCT T1.""Id"") AS ""Count"" 
                        FROM ""document"".""DocumentSubPosts"" T1
                        LEFT JOIN ""document"".""DocumentSubPosts"" T2
