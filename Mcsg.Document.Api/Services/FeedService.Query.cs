            ...
            get
            {
                return @"SELECT post.""Id"",post.""Title"", post.""Body"", post.""HashId"",
                        ...
                        post.""CustomNote"", array_agg(tag.""Name"") as Tags, u.""UserName"" from
                            ...
                            LEFT JOIN document.""DocumentMetaDatas"" md ON md.""PostId"" = p.""Id""
                            LEFT JOIN document.""DocumentPostLinks"" pl ON pl.""PostId"" = p.""Id"" AND pl.""IsDelete"" = false
                            LEFT JOIN LATERAL 
                            (
                                SELECT ""Id"",""HashId"",""PostId"",""Order"",""Body"", count(*) OVER() AS ""Total"" FROM ""document"".""DocumentSubPosts"" sp 
                            ...
                            (
                                ...
                                FROM ""document"".""DocumentResources"" r
            ...
            get
            {
                return @"SELECT post.""Id"",post.""Title"", post.""Body"", post.""HashId"",
                        ...
                        post.""CustomNote"", array_agg(tag.""Name"") as Tags from
                            ...
                            md.""Domain"" AS ""MetaDomain""
                            FROM (
                                SELECT DISTINCT qpost.* FROM ""document"".""DocumentPosts""  qpost
                                 INNER JOIN document.""DocumentTagPosts"" qtp ON qtp.""PostId"" = qpost.""Id""
                            ...
                            LEFT JOIN LATERAL 
                            (
                                SELECT ""Id"",""HashId"",""PostId"",""Order"", count(*) OVER() AS ""Total"" FROM ""document"".""DocumentSubPosts"" sp 
                                WHERE ""PostId"" = p.""Id""
                                GROUP BY ""Id"", ""PostId""
                                ORDER BY ""Order""
                                LIMIT 5
                            ...
                            (
                                SELECT ""SubPostId"",""Type"",""Status"",""BucketName"",""Url"",""MinioInstance"",""Name"",""HashId"",""Width"",""Height"",sp.""Order""
                                 FROM ""document"".""DocumentResources"" 
...
LIMIT @PageSize
                            ...
                            LEFT JOIN LATERAL 
                            (
                                SELECT ""Id"",""PostId"",""Order"", count(*) OVER() AS ""Total"" FROM ""document"".""DocumentSubPosts"" sp 
                                WHERE ""PostId"" = p.""Id"" AND ""IsDelete"" = false
                                GROUP BY ""Id"", ""PostId""
                                ORDER BY ""Order""
                                LIMIT 5
        ...
        private string GetFeedQuery
        {
            get
            {
                return @"SELECT 
                        ...
                        LEFT JOIN ""document"".""DocumentResources"" spr ON spr.""SubPostId"" = sp.""Id"" AND spr.""IsDelete"" = false    
                        LEFT JOIN document.""DocumentPostLinks"" pl ON pl.""PostId"" = p.""Id"" AND pl.""IsDelete"" = false 
                        WHERE 
            ...
            get
            {
                return @"
                    SELECT 
                        ...
                        END AS ""Link""
                    FROM
                        ""document"".""DocumentPosts""  p
                    LEFT JOIN 
                        identity.""Users"" u ON p.""UserId"" = u.""Id""
                    LEFT JOIN 
                        document.""DocumentMetaDatas"" md ON md.""PostId"" = p.""Id""
                    LEFT JOIN 
                        document.""DocumentPostLinks"" pl ON pl.""PostId"" = p.""Id"" AND pl.""IsDelete"" = FALSE
                    LEFT JOIN LATERAL (
                        SELECT
                            sp.""Id"",
                            sp.""HashId"",
                    ...
                    LEFT JOIN LATERAL (
                        ...
                        FROM
                            ""document"".""DocumentResources"" spr
                        WHERE
                            spr.""SubPostId"" = sp.""Id""
                        ...
                        post.""CustomNote"", array_agg(tag.""Name"") as Tags from
                            ...
                            FROM (
                                SELECT DISTINCT subqpost.* FROM 
                                    (
                                        SELECT qpost.* FROM ""document"".""DocumentPosts""  qpost
                                         INNER JOIN document.""DocumentTagPosts"" qtp ON qtp.""PostId"" = qpost.""Id""
                                        INNER JOIN ""Tags"" qtag ON qtp.""TagId"" = qtag.""Id"" 
        ...
        private string CheckUserFirstFeed
        {
            get
            {
                return @"SELECT ""Id"" FROM ""document"".""DocumentPosts""  WHERE ""UserId"" = @UserId AND ""Type"" = @PostType LIMIT 1;";
            }
        }
    }
}
