...
public class JobService : IJobService
{
    ...
    public async Task CreateConvertJob(DocumentResource resource, string userName, string userAvatar, string blobName)
    {
        resource.MicroService = MicroService.Document.ToString();
    ...
    private async Task ConvertVideo(DocumentResource resource, string userName, string userAvatar, string blobName)
    {
    ...
    private async Task ConvertAudio(DocumentResource resource, string userName, string userAvatar, string blobName)
    {
        bool canConvert = true;
        string fileExtension = Path.GetExtension(blobName);
        if (!Setting.FileExt.AllowPlayAfterUpload.Contains(fileExtension, StringComparer.OrdinalIgnoreCase))
