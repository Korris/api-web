...
public partial class SmartLookupService : ISmartLookupService
{
    ...
    public SmartLookupService(IMcsgContext context, ISetting setting, DistributeManager distributeManager, IRepository<Tag> tagRepository, IRepository<SmartLookupUser> smartLookupUserRepository, IRepository<SmartLookup> smartLookupRepository, IRepository<DocumentTagPost> tagPostRepository, IRepository<User> userRepository)
    {
        _context = context;
        _setting = setting;
