...
public static class NotificationExtension
{
    public static string ToMessage(this NotificationQueryResult noti)
    {
        ...
        #region -- Post --
        if (postEntities.Contains(noti.EntityType) && noti.Action == NotificationAction.Comment)
        {
            return noti.ActorName + NotificationContent.CommentOnFeed;
        }

        if (postEntities.Contains(noti.EntityType) && noti.Action == NotificationAction.Reaction)
        {
